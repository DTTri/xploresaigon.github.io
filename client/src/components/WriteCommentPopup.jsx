...
export default function WriteCommentPopup({ post, onClose }) {
  ...
  return (
    <div className='fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center'>
      <div className='px-10  relative bg-background dark:bg-secondDarkBackground dark:text-white rounded-3xl shadow-lg overflow-hidden w-full max-w-4xl max-h-[480px]'>
        ...
        <div className='flex justify-start h-full'>
          ...
          <div className='py-8 px-1 basis-2/3 overflow-hidden max-h-full'>
            ...
            <textarea className='resize-none w-full h-1/2 p-4 bg-white dark:bg-input rounded-2xl shadow-lg'></textarea>
          </div>
        </div>
      </div>
    </div>
